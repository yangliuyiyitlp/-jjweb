(function($, doc) {
  ...
  downloadButton.addEventListener('tap', function(event) {
    ...
    if(isAndroid){
      ...
      window.location.href='http://jjdc-client.oss-cn-shanghai.aliyuncs.com/jiujiuAndroid/app-release.apk';

    }else if(isiOS){
      /*if(isAlipay){
      document.getElementById('JweixinTip').style.display='block';
    }*/
      window.location.href='https://itunes.apple.com/cn/app/%E8%B5%B3%E8%B5%B3%E5%8D%95%E8%BD%A6/id1229952403?mt=8';
